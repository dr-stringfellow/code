 ...
 # CSV
    ...
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[473]/weights_syst[0]" "THW125-madgraph:weights_syst[473]/weights_syst[0]" "THQ125-madgraph:1.1889541161" "THW125-madgraph:1.0492369261" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" -mcpath ${TH_MCDIR}/systematics/JESDOWN/2t -varexpr "bdtout[28]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[473]/weights_syst[0]" "THW125-madgraph:weights_syst[473]/weights_syst[0]" "THQ125-madgraph:1.1889541161" "THW125-madgraph:1.0492369261" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" -mcpath ${TH_MCDIR}/systematics/JESUP/2t -varexpr "bdtout[28]"

    # JER

    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[473]/weights_syst[0]" "THW125-madgraph:weights_syst[473]/weights_syst[0]" "THQ125-madgraph:1.1889541161" "THW125-madgraph:1.0492369261" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" -mcpath ${TH_MCDIR}/systematics/JERDOWN/2t -varexpr "bdtout[28]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[473]/weights_syst[0]" "THW125-madgraph:weights_syst[473]/weights_syst[0]" "THQ125-madgraph:1.1889541161" "THW125-madgraph:1.0492369261" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" -mcpath ${TH_MCDIR}/systematics/JERUP/2t -varexpr "bdtout[28]"
