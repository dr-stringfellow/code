 ...
 # CSV
    ...
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[487]/weights_syst[0]" "THW125-madgraph:weights_syst[487]/weights_syst[0]" "THQ125-madgraph:1.0884158725" "THW125-madgraph:1.0298661536" "THQ125-madgraph:1.2224191675" "THW125-madgraph:1.2224191675" "TTH-powheg:1.2224191675" -mcpath ${TH_MCDIR}/systematics/JESDOWN/2t -varexpr "bdtout[42]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[487]/weights_syst[0]" "THW125-madgraph:weights_syst[487]/weights_syst[0]" "THQ125-madgraph:1.0884158725" "THW125-madgraph:1.0298661536" "THQ125-madgraph:1.2224191675" "THW125-madgraph:1.2224191675" "TTH-powheg:1.2224191675" -mcpath ${TH_MCDIR}/systematics/JESUP/2t -varexpr "bdtout[42]"

    # JER

    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[487]/weights_syst[0]" "THW125-madgraph:weights_syst[487]/weights_syst[0]" "THQ125-madgraph:1.0884158725" "THW125-madgraph:1.0298661536" "THQ125-madgraph:1.2224191675" "THW125-madgraph:1.2224191675" "TTH-powheg:1.2224191675" -mcpath ${TH_MCDIR}/systematics/JERDOWN/2t -varexpr "bdtout[42]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[487]/weights_syst[0]" "THW125-madgraph:weights_syst[487]/weights_syst[0]" "THQ125-madgraph:1.0884158725" "THW125-madgraph:1.0298661536" "THQ125-madgraph:1.2224191675" "THW125-madgraph:1.2224191675" "TTH-powheg:1.2224191675" -mcpath ${TH_MCDIR}/systematics/JERUP/2t -varexpr "bdtout[42]"
