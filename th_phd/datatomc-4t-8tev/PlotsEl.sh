...
th_datatomc_x tHel.config -varname transMLPout -stackmc 1 -batch 1 -xmax 1 -xmin -1 -signal TH125-madgraph:TH-madgraph-Summer12.root -datacuts "mlpouttrans<0.067" -signalfac 20 -nbinsx 15 -xtitle "MVA output"


th_datatomc_x tHel.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.1 -xmin -0.1 -signal TH125-madgraph:TH-madgraph-Summer12.root -datacuts "mlpout<0.54" -signalfac 20 -nbinsx 15 -xtitle "MVA output" -suffix "orig" -overflow 1 -underflow 1