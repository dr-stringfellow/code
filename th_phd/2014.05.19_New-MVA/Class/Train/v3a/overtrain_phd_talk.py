...
l.AddEntry(train_s,"tHq #scale[0.8]{(^{}#it{C}_{t}=-1)}","f")
l.AddEntry(train_b,"backgrounds","f")
l.Draw()
...
#l2.AddEntry(test_s,"signal test","lep")
#l2.AddEntry(test_b,"background test","lep")
l2.Draw()
