...
train_s = f.Get("Method_MLP/GlobalTHReco_BFGS/MVA_GlobalTHReco_BFGS_Train_S")
train_b = f.Get("Method_MLP/GlobalTHReco_BFGS/MVA_GlobalTHReco_BFGS_Train_B")
...
test_s = f.Get("Method_MLP/GlobalTHReco_BFGS/MVA_GlobalTHReco_BFGS_S")
test_b = f.Get("Method_MLP/GlobalTHReco_BFGS/MVA_GlobalTHReco_BFGS_B")
