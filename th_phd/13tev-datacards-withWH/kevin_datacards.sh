for i in {0..50}; do
    ...
    prod_ttH=$(sed -n $((${i}+1))'{p;q;}' prod_xsec_ttH.txt)    
...
echo '
 ...
 # CSV
    ...
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst['${j}']/weights_syst[0]" "THW125-madgraph:weights_syst['${j}']/weights_syst[0]" "THQ125-madgraph:'${kfactor_tHq}'" "THW125-madgraph:'${kfactor_tHW}'" "THQ125-madgraph:'${branching}'" "THW125-madgraph:'${branching}'" "TTH-powheg:'${branching}'" "TTH-powheg:'${prod_ttH}'" -mcpath ${TH_MCDIR}/systematics/JESDOWN/'${reg}' -varexpr "bdtout['${i}']" -nbinsx '${bins}'
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst['${j}']/weights_syst[0]" "THW125-madgraph:weights_syst['${j}']/weights_syst[0]" "THQ125-madgraph:'${kfactor_tHq}'" "THW125-madgraph:'${kfactor_tHW}'" "THQ125-madgraph:'${branching}'" "THW125-madgraph:'${branching}'" "TTH-powheg:'${branching}'" "TTH-powheg:'${prod_ttH}'" -mcpath ${TH_MCDIR}/systematics/JESUP/'${reg}' -varexpr "bdtout['${i}']" -nbinsx '${bins}'

    # JER

    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst['${j}']/weights_syst[0]" "THW125-madgraph:weights_syst['${j}']/weights_syst[0]" "THQ125-madgraph:'${kfactor_tHq}'" "THW125-madgraph:'${kfactor_tHW}'" "THQ125-madgraph:'${branching}'" "THW125-madgraph:'${branching}'" "TTH-powheg:'${branching}'" "TTH-powheg:'${prod_ttH}'" -mcpath ${TH_MCDIR}/systematics/JERDOWN/'${reg}' -varexpr "bdtout['${i}']" -nbinsx '${bins}'
    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst['${j}']/weights_syst[0]" "THW125-madgraph:weights_syst['${j}']/weights_syst[0]" "THQ125-madgraph:'${kfactor_tHq}'" "THW125-madgraph:'${kfactor_tHW}'" "THQ125-madgraph:'${branching}'" "THW125-madgraph:'${branching}'" "TTH-powheg:'${branching}'" "TTH-powheg:'${prod_ttH}'" -mcpath ${TH_MCDIR}/systematics/JERUP/'${reg}' -varexpr "bdtout['${i}']" -nbinsx '${bins}'
