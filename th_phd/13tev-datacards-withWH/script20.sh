    ...
    th_makedatacards_x tH.config MC.config ${1} -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[465]/weights_syst[0]" "THQ125-madgraph:0.9857948321" "THW125-madgraph:1.0015201042" "THW125-madgraph:weights_syst[465]/weights_syst[0]" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" "TTH-powheg:1.5625" -varexpr "bdtout[20]" -nbinsx 16
    #
    # rate systematics 
    #
