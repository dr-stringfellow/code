    ...
    th_makedatacards_x tH.config MC.config ${1} -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[464]/weights_syst[0]" "THQ125-madgraph:0.9623897517" "THW125-madgraph:0.985720831" "THW125-madgraph:weights_syst[464]/weights_syst[0]" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" -varexpr "bdtout[19]"
    #
    # rate systematics 
    #
