    ...
    export REGION=3t
    export DATACARD=tH_${REGION}_0
    
    rm ${DATACARD}.txt
    rm ${DATACARD}.root 
    

    th_makedatacards_x tH.config MC.config ${1} -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -varexpr "bdtout[0]"
    #
    # rate systematics 
    #
    ...
    # Q2 Scale
    th_makedatacards_x tH.config MC.config -systematic Q2scale_tHq -direction Up   -mcweights+ "THQ125-madgraph:weights_syst[4]/weights_syst[0]" -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" -varexpr "bdtout[0] "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:"

    th_makedatacards_x tH.config MC.config -systematic Q2scale_tHq -direction Down -mcweights+ "THQ125-madgraph:weights_syst[8]/weights_syst[0]" -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -varexpr "bdtout[0]"
 ...
 # CSV
    ...
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JESDOWN/3t -varexpr "bdtout[0]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JESUP/3t -varexpr "bdtout[0]"

    # JER

    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JERDOWN/3t -varexpr "bdtout[0]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JERUP/3t -varexpr "bdtout[0]"
 ...
 # CSV
    ...
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JESDOWN/4t -varexpr "bdtout[0]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jes  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JESUP/4t -varexpr "bdtout[0]"

    # JER

    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Down -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JERDOWN/4t -varexpr "bdtout[0]"
    th_makedatacards_x tH.config MC.config -systematic CMS_jer  -direction Up -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[0]/weights_syst[0]" "THW125-madgraph:weights_syst[0]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -mcpath /storage/a/singletophiggs/Moriond/winter14-jan07/mc/ana-nominal/systematics/JERUP/4t -varexpr "bdtout[0]"
