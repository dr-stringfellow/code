    ...
    export REGION=3t
    export DATACARD=tH_${REGION}_15
    
    rm ${DATACARD}.txt
    rm ${DATACARD}.root 
    

    th_makedatacards_x tH.config MC.config ${1} -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[460]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "THW125-madgraph:weights_syst[460]/weights_syst[0]" "THQ125-madgraph:" "THW125-madgraph:" "TTH-powheg:" -varexpr "bdtout[15]"
    #
    # rate systematics 
    #
