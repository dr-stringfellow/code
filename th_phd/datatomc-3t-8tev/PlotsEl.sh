...
th_datatomc_x tHel.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.7 -xmin -0.3 -lumi 0 -suffix "lumi0"
...
th_datatomc_x tHel.config -varname RecMLPout -stackmc 1 -batch 1 -suffix "log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -logy 1 -overflow 1
th_datatomc_x tHel.config -varname RecMLPout -stackmc 1 -batch 1 -xmin -0.2 -xmax 2.0 -nbinsx 50 -overflow 1
...
th_datatomc_x tHel.config -varname TopRecMLPout -stackmc 1 -batch 1 -suffix "log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -logy 1 -overflow 1
th_datatomc_x tHel.config -varname TopRecMLPout -stackmc 1 -batch 1 -xmin -0.2 -xmax 2.0 -nbinsx 50 -overflow 1
...
th_datatomc_x tHel.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.7 -xmin -0.3 -signal TH125-madgraph:TH-madgraph-Summer12.root -logy 1 -datacuts "mlpout<0.7" -overflow 1


th_datatomc_x tHel.config -varname transMLPout -stackmc 1 -batch 1 -xmax 1 -xmin -1 -signal TH125-madgraph:TH-madgraph-Summer12.root -datacuts "mlpouttrans<0.067" -signalfac 50 -nbinsx 15 -xtitle "MVA output"

th_datatomc_x tHel.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.1 -xmin -0.1 -signal TH125-madgraph:TH-madgraph-Summer12.root -datacuts "mlpout<0.54" -signalfac 50 -nbinsx 15 -xtitle "MVA output" -suffix "orig" -overflow 1 -underflow 1
