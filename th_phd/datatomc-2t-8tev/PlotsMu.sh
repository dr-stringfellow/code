...
th_datatomc_x tHmu.config -varname RecMLPout -stackmc 1 -batch 1 -resmax 0.5 -lumi 0 -suffix "lumi0_log" -xmin -0.2. -xmax 2.0 -nbinsx 50 -logy 1 -overflow 1
th_datatomc_x tHmu.config -varname RecMLPout -stackmc 1 -batch 1 -resmax 0.5 -lumi 0 -suffix "lumi0" -xmin -0.1 -xmax 1.1 -nbinsx 30 -overflow 1
...
th_datatomc_x tHmu.config -varname TopRecMLPout -stackmc 1 -batch 1 -resmax 0.5 -lumi 0 -suffix "lumi0_log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -logy 1 -overflow 1
th_datatomc_x tHmu.config -varname TopRecMLPout -stackmc 1 -resmax 0.5 -batch 1 -xmin -0.1 -xmax 1.1 -nbinsx 30 -overflow 1 -lumi 0 -suffix "lumi0"
...
th_datatomc_x tHmu.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.3 -xmin -0.3 -nbinsx 25 -xtitle "MVA output" -lumi 0 -suffix "lumi0"
...
th_datatomc_x tHmu.config -varname RecMLPout -stackmc 1 -batch 1 -resmax 0.5 -suffix "log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -logy 1 -overflow 1
th_datatomc_x tHmu.config -varname RecMLPout -stackmc 1 -batch 1 -resmax 0.5 -suffix "log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -overflow 1
...
th_datatomc_x tHmu.config -varname TopRecMLPout -stackmc 1 -batch 1 -resmax 0.5 -suffix "log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -logy 1 -overflow 1
th_datatomc_x tHmu.config -varname TopRecMLPout -stackmc 1 -batch 1 -resmax 0.5 -suffix "log" -xmin -0.2 -xmax 2.0 -nbinsx 50 -overflow 1
...
th_datatomc_x tHmu.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.7 -xmin -0.3
th_datatomc_x tHmu.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.1 -xmin -0.1 -nbinsx 15 -xtitle "MVA output"
th_datatomc_x tHmu.config -varname MLPout -stackmc 1 -batch 1 -xmax 1.1 -xmin -0.1 -nbinsx 15 -xtitle "MVA output" -suffix "lumi0" -lumi 0 -xtitle "NN output"