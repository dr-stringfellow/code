...
sed -i ''s/${j}/${i}/g'' /home/bmaier/thanalysis/th_phd/13tev-lumistudies/Lumi.config
. script0.sh
. script12.sh

python  add_stat_shapes.py --prefix='' --normalize --filter=*nominal tH_3t_0.root  tH_3t_0.root --writeDC
python  add_stat_shapes.py --prefix='' --normalize --filter=*nominal tH_4t_0.root  tH_4t_0.root --writeDC
python  add_stat_shapes.py --prefix='' --normalize --filter=*nominal tH_3t_12.root  tH_3t_12.root --writeDC
python  add_stat_shapes.py --prefix='' --normalize --filter=*nominal tH_4t_12.root  tH_4t_12.root --writeDC
