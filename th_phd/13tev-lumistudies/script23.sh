    ...
    th_makedatacards_x tH.config MC.config ${1} -datacard ${DATACARD}.txt -rootfile ${DATACARD}.root -mcweights+ "THQ125-madgraph:weights_syst[468]/weights_syst[0]" "THQ125-madgraph:1.044808528" "THW125-madgraph:1.0104641032" "THW125-madgraph:weights_syst[468]/weights_syst[0]" "THQ125-madgraph:0.767312488" "THW125-madgraph:0.767312488" "TTH-powheg:0.767312488" -varexpr "bdtout[23]"
    #
    # rate systematics 
    #
