...
int main(int argc,char**argv)
{
  ...
  if (!mcsamples.empty()) {
    ...
    if(sys==3)
      tex.DrawLatex(0.56,0.95,"Top p_{T} reweighting");
    if(sys==4)
      tex.DrawLatex(0.56,0.95,"Q^{2} scale variation");
    tex.DrawLatex(0.687,0.81,"#it{Simulation}");
    tex.DrawLatex(0.672,0.765,"#it{Premilinary}");
    ...
    tex2.DrawLatex(0.76,0.86,"#bf{CMS}");
