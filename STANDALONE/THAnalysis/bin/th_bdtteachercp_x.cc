...
int main(int argc,char**argv)
{
  ...
  string spec1 ="topjtidx_cp[" + cp_weight_idx + "]";
  string spec2 ="ljtidx_cp[" + cp_weight_idx + "]";
  string spec3 ="hbbjtidx_cp[0][" + cp_weight_idx + "]";
  string spec4 ="hbbjtidx_cp[1][" + cp_weight_idx + "]";
