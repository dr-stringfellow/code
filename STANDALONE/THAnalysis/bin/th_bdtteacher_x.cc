...
int main(int argc,char**argv)
{
  ...
  string         bdtconfig     = cl.getValue<string>   ("bdtconfig",           "");
  ...
  string signalweight         = cl.getValue<string>  ("signalweight",        "");
  ...
  TString outfileName( "BDT_tH_class.root" );
  ...
  TMVA::Factory *factory = new TMVA::Factory( "tH", outputFile,  // I;D;P;G,D
  ...
  string spec1 ="topjtidx[" + cvcf_weight_idx + "]";
  string spec2 ="ljtidx[" + cvcf_weight_idx + "]";
  string spec3 ="hbbjtidx[0][" + cvcf_weight_idx + "]";
  string spec4 ="hbbjtidx[1][" + cvcf_weight_idx + "]";

  factory->AddSpectator(spec1.c_str());
  factory->AddSpectator(spec2.c_str());
  factory->AddSpectator(spec3.c_str());
  factory->AddSpectator(spec4.c_str());
...
/*
  ...
  string signalweight_expr = weight_expr + "*" + signalweight;

  cout << "#############################"<< endl;
  cout << "weight expression:" << endl;
  cout << weight_expr << endl;
  cout << signalweight_expr << endl;
  cout << "#############################"<< endl;
  

  factory->SetBackgroundWeightExpression(weight_expr);
  factory->SetSignalWeightExpression(signalweight_expr);
