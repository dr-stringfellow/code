...
int main(int argc,char**argv)
{
  ...
  string cvcfmap="weights_syst[0]/weights_syst[0]";

  

  TMVA::Reader *reader_th_0 = new TMVA::Reader( "!Color:!Silent" );
  TString  weightfiles_th=TString(bdtpath) +"/"+ TString("BDTreco_expert_BDT.weights.xml");

  master_reader_th(reader_th_0,cvcfmap,weightfiles_th);
